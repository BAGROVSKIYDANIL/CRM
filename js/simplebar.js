        ...
        SimpleBarCore.prototype.positionScrollbar = function (axis) {
            ...
            scrollbar.el.style.transform =
                axis === 'x'
                    ...
                    console.log('размер скролла', scrollbar.size)
                    console.log('текущее смещение', scrollOffset)
                    console.log('размер контейнера', hostSize)
                    console.log('размер контента', contentSize)
                    console.log('процент прокрутки контента', scrollPourcent);
                    console.log('размер трека', trackSize);
                    console.log('смещение', handleOffset);
